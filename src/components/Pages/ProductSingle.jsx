...
import single1 from '../../--assets/images/shop/1.jpg'
import single2 from '../../--assets/images/shop/2.jpg'
import single3 from '../../--assets/images/shop/3.jpg'
import single4 from '../../--assets/images/shop/4.jpg'
              ...
              <div className="row">
                <div className="col-xs-6">
...

                   {
                     ...
                     <h3><span>{product.regular_price}TK</span></h3>
                     :
                     <h3><del>{product.regular_price}TK</del><span>{product.sale_price}TK</span></h3>
                   }
